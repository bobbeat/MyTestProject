 ...
 **********************************************************************
 ...
 \see
 **********************************************************************/
Guint32 GPI_CreateThread(THREADPROCFUNC threadProcFunc, void *pParam)
{
 ...
 **********************************************************************
 ...
 \see
 **********************************************************************/
void GPI_DestroyThread(Guint32 hThread)
{
 ...
 **********************************************************************
 ...
 \see
 **********************************************************************/
void GPI_SuspendThread(Guint32 hThread)
{
    if(!hThread)
        return;
    GDTHREADHANDLE *handle = (GDTHREADHANDLE*)hThread;
 ...
 **********************************************************************
 ...
 \see
 **********************************************************************/
void GPI_ResumeThread(Guint32 hThread)
{
    if(!hThread)
        return;
    GDTHREADHANDLE *handle = (GDTHREADHANDLE*)hThread;
 ...
 **********************************************************************
 ...
 \see
 **********************************************************************/
void GPI_SetThreadPriority(Guint32 hThread, enumTHREADPRIORITY euPriority)
{
    if(!hThread)
        return;
    GDTHREADHANDLE *handle = (GDTHREADHANDLE*)hThread;
