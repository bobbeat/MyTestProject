...
#include "gpimacro.h"
     ...
     *********************************************************************
     ...
     \see
     **********************************************************************/
    GPI_API_CALL Guint32 GPI_CreateSemaphore();
     ...
     *********************************************************************
     ...
     \see
     **********************************************************************/
    GPI_API_CALL void GPI_DestroySemaphore(Guint32 hHandle);
     ...
     *********************************************************************
     ...
     \see
     **********************************************************************/
    GPI_API_CALL Gbool GPI_WaitForSemaphore(Guint32 hHandle, Gint32 nLimitMillis);
     ...
     *********************************************************************
     ...
     \see
     **********************************************************************/
    GPI_API_CALL void GPI_TriggerSemaphore(Guint32 hHandle);
     ...
     *********************************************************************
     ...
     \see
     **********************************************************************/
    GPI_API_CALL void GPI_ResetSemaphore(Guint32 hHandle);
