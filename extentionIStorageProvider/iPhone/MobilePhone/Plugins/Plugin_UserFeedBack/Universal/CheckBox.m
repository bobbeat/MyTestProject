...
- (id)initWithDelegate:(id)delegate {
    ...
    if (self) {
        ...
        [self setImage:[UIImage imageNamed:@"feedBackBox.png"] forState:UIControlStateNormal];
        [self setImage:[UIImage imageNamed:@"feedBackCheck_on.png"] forState:UIControlStateSelected];
