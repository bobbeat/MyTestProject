...
#开始编译
xcodebuild -project AutoNavi.xcodeproj -sdk iphoneos8.1 -configuration Debug clean
xcodebuild -project AutoNavi.xcodeproj -sdk iphoneos8.1 -configuration Debug 
#压缩成ipa包
...
#开始编译
xcodebuild -project AutoNavi.xcodeproj -sdk iphoneos8.1 -configuration Distribution clean
xcodebuild -project AutoNavi.xcodeproj -sdk iphoneos8.1 -configuration Distribution 
#压缩成ipa包
