 ...
 *********************************************************************
 ...
 \see
 **********************************************************************/
void GPI_DestroySemaphore(Guint32 hHandle)
{
	bool ret = false;
 ...
 *********************************************************************
 ...
 \see
 **********************************************************************/
Gbool GPI_WaitForSemaphore(Guint32 hHandle, Gint32 nLimitMillis)
{
	Gbool bRet = Gfalse;
	sem_t* lpSem = (sem_t*)hHandle;
	if(lpSem==NULL)
 ...
 *********************************************************************
 ...
 \see
 **********************************************************************/
void GPI_TriggerSemaphore(Guint32 hHandle)
{
	sem_t* lpSem = (sem_t*)hHandle;
	if(lpSem==NULL)
		return ;
 ...
 *********************************************************************
 ...
 \see
 **********************************************************************/
void GPI_ResetSemaphore(Guint32 hHandle)
{
