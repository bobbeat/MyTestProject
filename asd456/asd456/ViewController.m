...
//  asd456
//
//  Created by gaozhimin on 15/5/7.
...
//    fun1();
    ...
    lpSem = sem_open( "test", O_CREAT, 0644, 0);
    if( lpSem == SEM_FAILED )
    {
        NSLog(@"faild");
    }
    int num = -1;
    int res = sem_getvalue(lpSem, &num);
    sem_post((sem_t*)lpSem);
    sem_post((sem_t*)lpSem);
    sem_post((sem_t*)lpSem);
    
    num = sem_trywait((sem_t*)lpSem);
     num = sem_trywait((sem_t*)lpSem);
     num = sem_trywait((sem_t*)lpSem);
     num = sem_trywait((sem_t*)lpSem);
     num = sem_trywait((sem_t*)lpSem);
     ...
     num = sem_trywait((sem_t*)lpSem);
     num = sem_trywait((sem_t*)lpSem);
    lpSem2 =  sem_open( "test", O_EXCL, 0644, 0);
    if( lpSem2 == SEM_FAILED )
    {
        NSLog(@"faild");
    }
    sem_wait((sem_t*)lpSem);
    sem_wait((sem_t*)lpSem);
    sem_wait((sem_t*)lpSem);
    sem_wait((sem_t*)lpSem);
    sem_wait((sem_t*)lpSem);
