...
#include "gpimacro.h"
     ...
     **********************************************************************
     ...
     \see
     **********************************************************************/
    GPI_API_CALL void* GPI_CreateThread(THREADPROCFUNC threadProcFunc, void *pParam);
     ...
     **********************************************************************
     ...
     \see
     **********************************************************************/
    GPI_API_CALL void GPI_DestroyThread(void* hThread);
     ...
     **********************************************************************
     ...
     \see
     **********************************************************************/
    GPI_API_CALL void GPI_SuspendThread(void* hThread);
     ...
     **********************************************************************
     ...
     \see
     **********************************************************************/
    GPI_API_CALL void GPI_ResumeThread(void* hThread);
     ...
     **********************************************************************
     ...
     \see 
     **********************************************************************/
    GPI_API_CALL void GPI_SetThreadPriority(void* hThread, enumTHREADPRIORITY euPriority);
