...
#define kAZJNRequestTimeOutInterval      12.0//异步超时时间
...
- (void)connect
{
    ...
    [NSMutableURLRequest requestWithURL:[NSURL URLWithString:urlString]
                        ...
                        timeoutInterval:_requestCondition.timeout?_requestCondition.timeout:kAZJNRequestTimeOutInterval];//若设置超时时间，则使用超时时间，否则为默认12s
